...
def generate_new(
    ...
    #     )
    #     hops = [
    #         {"style": "legacy", "pubkey": first_pubkey, "payload": first_hop_data,},
    #         {"style": "legacy", "pubkey": next_pubkey, "payload": next_hop_data,},
    #     ]
    #     gen_onion = config.rpc.createonion(hops, payment_hash.hex())
